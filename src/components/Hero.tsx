    ...
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="container relative z-10 py-20">
        <motion.div
          ...
          className="max-w-2xl"
        >
          <span className="inline-block mb-4 px-4 py-1.5 rounded-full bg-primary/20 text-amber-glow font-body text-sm font-semibold tracking-wide uppercase">
          ...
          <h1 className="text-5xl md:text-7xl font-heading font-extrabold leading-[1.05] tracking-tight text-primary-foreground mb-6">
            Protect & Beautify
            <br />
            <span className="text-primary">Your Concrete</span>
          </h1>
          <p className="text-lg md:text-xl text-section-dark-foreground/80 font-body mb-10 max-w-lg">
            Professional concrete sealing, coating, and restoration services throughout the Okanagan. We make your surfaces last.
          </p>
